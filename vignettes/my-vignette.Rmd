...
```{r}
data(df_rosters) # <- readRDS("../inst/df_rosters_prepped_data.rds")
data(df_rosters1) # <- readRDS("../inst/df_rosters1_raw_data.rds")
...
for(i in 1:length(races)){
  race_name <- races[i]
  gridExtra::grid.arrange(create_rosterplot(df_rosters, group_name, race_name))
