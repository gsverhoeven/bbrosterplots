# bbrosterplots: an R package to visualize Blood Bowl rosters
...
<!-- badges: start -->
  [![R-CMD-check](https://github.com/gsverhoeven/bbrosterplots/actions/workflows/R-CMD-check.yaml/badge.svg)](https://github.com/gsverhoeven/bbrosterplots/actions/workflows/R-CMD-check.yaml)
  <!-- badges: end -->
